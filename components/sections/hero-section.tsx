...
export function HeroSection() {
  ...
  return (
    <section className="relative w-full bg-[#082b2f] pt-32 pb-32">
      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-8">
          ...
          <div>
            <Link href="#">
              <ShinyButton className="inline-flex items-center justify-center !px-8 !py-4 rounded-full text-base font-semibold shadow-lg hover:shadow-xl translate-y-0">Daftar Kelas Percubaan</ShinyButton>
            </Link>
          </div>
        </div>
